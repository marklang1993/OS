...
FS_OBJECTS = inode.o fs_lib.o directory.o dinode.o file_desc.o
...
directory.o:kernel/drivers/fs/directory.c
		$(GCC) $(GCC_FLAGS) -o $@ $<

dinode.o:	kernel/drivers/fs/dinode.c
		$(GCC) $(GCC_FLAGS) -o $@ $<

file_desc.o: kernel/drivers/fs/file_desc.c
		$(GCC) $(GCC_FLAGS) -o $@ $<
